...
{
 CAN_6623_ID					=0x1FF,
 CAN_6623_PITCH_ID		=0x205,
 CAN_6623_YAW_ID			=0x206,
 ...
 CAN_T_GYRO_ID				=0x40,	
 CAN_GYRO_ID					=0x41,//T型板陀螺仪id
 CAN_ACCE_ID					=0x42,//T型板陀螺仪id
 CAN_LASER_SID				=0x50,
 CAN_LASER_RID				=0x51,
}CAN_ID;
...
//__CAN_EXT CAN_6623_REC		gmp_rec;
//__CAN_EXT CAN_6623_REC		gmy_rec;
 ...
 void gyro_senddata(CAN_TypeDef* CANx);
 void laser_senddata(CAN_TypeDef* CANx,uint8_t mode);
